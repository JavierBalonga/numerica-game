    ...
    <div className="flex flex-col items-center gap-8 p-8 bg-slate-700/25 rounded-2xl">
      ...
      <div className="relative rounded-md shadow-sm">
        <input
          type="text"
          name="twitchUsername"
          className="block w-full rounded-md border-0 py-3 px-6 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-400 text-2xl sm:leading-6"
